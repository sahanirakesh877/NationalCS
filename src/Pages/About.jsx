      ...
      <div className="container py-5 mx-auto px-4">
        <div className="row d-flex justify-content-between  align-items-center ">
          ...
          <div className="col-md-6">
            <h3></h3>
            <p className="aboutp">
              <span className="text-danger text-bold fw-bold ">NCRC</span> is the first dedicated center to providing state-of-the-art
              focused Colorectal care to patients across Nepal, combining
              advanced medical and surgical expertise with a commitment to
              compassion and patient’s satisfaction which is Led by a team of
              highly skilled Colorectal Surgeons and other associated
              specialists. We offer a comprehensive range of services including
              screenings, diagnostics, surgical interventions, and latest
              ongoing management of colorectal diseases. With a focus on
              promoting awareness, prevention, and early detection, we strive to
